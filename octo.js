...
function math(x, y, op) {
	switch(op) {
		...
		case 0x4: v[0xF] = (v[x]+v[y] > 0xFF) ?1:0; v[x] = (v[x] + v[y]) & 0xFF; break;
		case 0x5: v[0xF] = (v[x] > v[y])      ?1:0; v[x] = (v[x] - v[y]) & 0xFF; break;
		case 0x6: v[0xF] = ( v[y]       & 0x1);     v[x] = (v[y] >> 1)   & 0xFF; break;
		case 0x7: v[0xF] = (v[y] > v[x])      ?1:0; v[x] = (v[y] - v[x]) & 0xFF; break;
		case 0xE: v[0xF] = ((v[y] >> 7) & 0x1);     v[x] = (v[y] << 1)   & 0xFF; break;
